 var dbName = "klientmesto7";
    ...
    var selektovanocheckboxas = $("input[name*=checkboxas-]:checked").val();
      ...
      klDB.indexedDB.open = function() {
		...
		klDB.indexedDB.addMestos = function(ter, tm, todointerkey, t, tododatumnalog, dat, tmes, tsat, mg, rad, pod, pod2, pod3, voz, m, r, o, boxa, pov, rads, pods, pods2, pods3, vozs, ms, rs, os, boxas, povs) {
        var db = klDB.indexedDB.db;
    ...
    function addTodo2() {
	  ...
	  function showtrenutno() {
        ...
        request.onsuccess = function(event) {
		  ...
		  var ul = document.createElement("ul");
		  var prom =  document.querySelector("#ourormar").innerHTML;
