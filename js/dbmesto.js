 var dbName = "gradovi";
    ...
    $('select').selectmenu();
      ...
      todoDB.indexedDB.open = function() {
        ...
        request.onupgradeneeded = function(e) {
          ...
          console.log ("Going to upgrade our DB from version: "+ e.oldVersion + " to " + e.newVersion);
            ...
            store.put({title: "Aleksinac", author: "Advokatska kancelarija", saradnik: "saradnik1", isbn: 1});
			store.put({title: "Krusevac", author: "Advokatska kancelarija", saradnik: "saradnik2", isbn: 2});
			store.put({title: "Leskovac", author: "Advokatska kancelarija", saradnik: "saradnik3", isbn: 3});
			store.put({title: "Nis", author: "Agencija", saradnik: "saradnik4", isbn: 4});
			store.put({title: "Pirot", author: "Advokatska kancelarija", saradnik: "saradnik5", isbn: 5});
			store.put({title: "Prokuplje", author: "Advokatska kancelarija", saradnik: "saradnik6", isbn: 6});
			store.put({title: "Vranje", author: "Advokatska kancelarija", saradnik: "saradnik7", isbn: 7});
			store.put({title: "Zrenjanin", author: "Advokatska kancelarija", saradnik: "saradnik8", isbn: 8});
		...
		todoDB.indexedDB.addMesto = function(todoTitle, todoAuthor) {
        var db = todoDB.indexedDB.db;
      ...
      todoDB.indexedDB.addMestoisaradnik = function(todoTitle, todoAuthor, saradnik) {
        var db = todoDB.indexedDB.db;
        var trans = todoDB.indexedDB.db.transaction("mesto", "readwrite");
        var store = trans.objectStore("mesto");
      ...
      function renderTodo(row) {
        ...
        var t = document.createTextNode(row.title);
		 ...
		 var p1 = document.createTextNode(row.saradnik);
	  ...
	  function addMesto() {
        ...
        if (title.value.length > 0) {
          todoDB.indexedDB.addMesto(title.value, author.value);
          title.value = "";
		  author.value = "";
        };
      }
      function addMestoisaradnik() {
        var title = document.getElementById("mesto");
		var author = document.getElementById("author");
		var saradnik = document.getElementById("saradnik");
        if (title.value.length > 0) {
