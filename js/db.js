 var dbName = "mesta";
    ...
    $('<option>').attr({'value':'2'}).html(selektovatimesto).appendTo('#select-choice-kljuc');    
      ...
      todoDB.indexedDB.open = function() {
        ...
        request.onupgradeneeded = function(e) {
          ...
          console.log ("Going to upgrade our DB from version: "+ e.oldVersion + " to " + e.newVersion);
            ...
            store.put({title: "Aleksinac", author: "Fred", isbn: 1});
			store.put({title: "Krusevac", author: "Fred", isbn: 2});
			store.put({title: "Leskovac", author: "Barney", isbn: 3});
			store.put({title: "Nis", author: "Barney", isbn: 4});
			store.put({title: "Pirot", author: "Barney", isbn: 5});
			store.put({title: "Prokuplje", author: "Barney", isbn: 6});
			store.put({title: "Vranje", author: "Barney", isbn: 7});
			store.put({title: "Zrenjanin", author: "Barney", isbn: 8});
