	   ...
	   function showauthor() {
        ...
        request.onsuccess = function(event) {
          ...
          request.onsuccess = function(event) {
            ...
            var li = document.createElement("li");
            li.textContent = "key: " + cursor.key + " => tit: " + cursor.value.id + cursor.value.title + cursor.value.author;
            ul.appendChild(li);
            cursor.continue();
          }
        }                    
	  ...
	  function selektovatiMesto() {
        ...
        request.onsuccess = function(event) {
          ...
          request.onsuccess = function(event) {
            ...
            option.textContent = "key: " + cursor.key + " => tit: " + cursor.value.id + cursor.value.title + cursor.value.author;
            select.appendChild(option);
            cursor.continue();
          }
        }                    
